...
namespace Microsoft.Owin.Hosting {
    ...
    internal class Resources {
        ...
        internal static string Exception_AppLoadFailure {
            get {
                return "The following errors occurred while attempting to load the app.";
            }
        }
        ...
        internal static string Exception_FailedToResolveService {
            get {
                return "Failed to resolve an instance of {0} from the IServiceProvider.";
            }
        }
        ...
        internal static string Exception_ImproperlyFormattedSettingsFile {
            get {
                return "The settings file is improperly formatted. It should consist of one name=value pair per line.  Empty lines or lines beginning with '#' are ignored.";
            }
        }
        ...
        internal static string Exception_ServerFactoryParameterCount {
            get {
                return "The '{0}' Create method must take two parameters.";
            }
        }
        ...
        internal static string Exception_ServerFactoryParameterType {
            get {
                return "The '{0}' Create method must have a second parameter of type IDictionary<string,object>.";
            }
        }
        ...
        internal static string Exception_ServerNotFound {
            get {
                return "The server factory could not be located for the given input: {0}";
            }
        }
    }
}
